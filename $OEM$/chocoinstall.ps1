...
winget install 9NBLGGH5L9XT --accept-package-agreements --accept-source-agreements
...
winget install ElectronicArts.EADesktop --accept-package-agreements --accept-source-agreements
winget install EpicGames.EpicGamesLauncher --accept-package-agreements --accept-source-agreements
winget install RARLab.WinRAR --accept-package-agreements --accept-source-agreements
