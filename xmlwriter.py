...
class Writer():
    ...
    # Pass functions
    def add_win_pe_pass(self, setuplang:str="en-US", inputlocale:list | None = None, systemlocale:str="en-US", userlocale:str="hu-HU",
                        windowsedition:str="Professional",fullname:str="teszt_elek",organization:str="",virtual_machine:None | bool =None):
        if inputlocale is None:
            inputlocale = ["en-US"]
        pepass=ET.SubElement(self.root,"settings",{"pass":"windowsPE"})

        # adds winPE_Core component
        component_winpe=ET.SubElement(pepass, "component",self.component("Microsoft-Windows-International-Core-WinPE"))
        ...
        if virtual_machine is True:
            ...
            ET.SubElement(runcommand_tpmbypass,"Path").text="reg add HKLM\System\Setup\LabConfig /v BypassTPMCheck /t reg_dword /d 0x00000001 /f"
            #Bypass Secure Boot
    ...
    def add_offlineservicing_pass(self,enable_user_acc_control: None | bool=None, enable_code_integrity: None | bool =None):
